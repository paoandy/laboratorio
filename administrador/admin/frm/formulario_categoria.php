<?php
	...
	$form->add('label', 'label_message', 'descripcion', 'Descripcion:');
	    ...
	    $costo = $_POST['costo'];
	     ...
	     $consulta = $query->getRowsArray('NOMBRECATEGORIA' ,'categoria',"WHERE nombrecategoria= '".$nombrecategoria."'");
	      if ( sizeof($consulta)) { 
	      echo "<script> $(document).ready(function() { Messenger().post({ message: 'La Categoria que quiere registrar Existe.',  showCloseButton: true }); }); </script>";	// Avisa que existe el usuario
